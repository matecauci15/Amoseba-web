...
//   return (
//     <section className="min-h-screen rounded-lg shadow-lg flex flex-col justify-center items-center bg-gray-100 px-6 md:px-12 py-16 mt-10 max-w-7xl mx-auto text-center mb-10 font-montserrat">
//       <div className="max-w-4xl w-full grid md:grid-cols-1 gap-6 items-center">
//         {/* Contenido de texto */}
//         {/* <div className="text-justify"> */}
//         <div className="text-center md:text-justify">
//           <h2 className="text-4xl font-bold text-[#A39F73] mb-6 text-center -mt-6">Sobre Nosotros</h2>
//           <p className="text-lg text-gray-700 leading-relaxed">
//             La <strong>Asociación Mutual Obreros, Empleados de la Salud y Educación de la Ciudad de Buenos Aires (AMOESYECBA)</strong> fue fundada en 2004 con un propósito claro: <span className="whitespace-nowrap">mejorar continuamente</span> la calidad de vida de sus socios.
//           </p>
