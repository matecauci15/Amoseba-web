...
export const Contact = () => {
  ...
  return (
    <div className=" mx-auto mt-10 bg-gradient-to-b from-[#CAC792] to-gray-50">
          ...
          <h2 className="text-5xl font-bold text-center items-center  text-white mt-2 mb-6">Nuestra Ubicación</h2>
  ...
  <div className="rounded-xl overflow-hidden transform transition-all hover:scale-[1.01] duration-300 max-w-4xl w-full">
    ...
    />
          ...
          <h1 className="text-4xl text-white  font-bold text-center mb-2">Contáctanos</h1>
          <p className="text-center text-white mb-5 opacity-90">Estamos aquí para ayudarte</p>
          <form onSubmit={formik.handleSubmit} className="mb-10 space-y-6 max-w-lg mx-auto bg-white shadow-lg rounded-xl p-10">
  {/* Name Input */}
